  ...
  const handleAnalyze = async () => {
    ...
    setTimeout(() => {
      setResult({
        ...
        confidence: 87.5,
        details: 'Opacidad en el lóbulo inferior derecho compatible con proceso infeccioso',
        recommendations: [
          'Iniciar tratamiento antibiótico',
          'Seguimiento en 48-72 horas',
          'Considerar estudios complementarios si no hay mejoría'
        ]
      })
      setAnalyzing(false)
    }, 2500)
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Image src="/logo.jpg" alt="DOCTOR AI LOGO" width={80} height={40} />
              <div>
                <h1 className="text-xl font-bold text-gray-900">Diagnóstico IA</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          {/* Upload Section */}
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Cargar Imagen de Rayos X</h2>
            ...
            <div className="mt-6 bg-blue-50 border border-blue-100 rounded-lg p-4">
              <div className="flex gap-3">
                ...
                <div>
                  <h3 className="font-medium text-blue-900 mb-1">Recomendaciones</h3>
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• Asegúrate de que la imagen sea clara y bien iluminada</li>
                    <li>• Formatos aceptados: PNG, JPG, WEBP</li>
                    <li>• El análisis es una herramienta de apoyo, no sustituye el criterio médico</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            {!result && !analyzing && (
              <div className="border border-gray-200 rounded-lg p-12 text-center">
                ...
                <p className="text-gray-600">
                  Los resultados del análisis aparecerán aquí una vez que se complete el procesamiento
                </p>
              </div>
            )}
            ...
            {analyzing && (
              <div className="border border-gray-200 rounded-lg p-12 text-center">
                ...
                <p className="text-gray-900 font-medium">Procesando imagen...</p>
                <p className="text-sm text-gray-600 mt-1">El modelo de IA está analizando la imagen</p>
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 mb-1">Diagnóstico</h3>
                      <p className="text-2xl font-bold text-blue-600">{result.diagnosis}</p>
                    </div>
                ...
                {/* Details */}
                <div className="border border-gray-200 rounded-lg p-6">
                  <h3 className="font-bold text-gray-900 mb-3">Detalles del Análisis</h3>
